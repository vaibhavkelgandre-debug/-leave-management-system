...
// HR_ADMIN (who can see everyone), or a MANAGER whose reporting subtree
// includes the target user — enforces the org-hierarchy visibility rule so
// managers can't view/act on arbitrary employees outside their team.
